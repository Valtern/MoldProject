    ...
    <div className="w-full max-w-[1280px] mx-auto transition-all">
      <div className="px-3 py-3 md:p-6 lg:p-8">
        <div className="flex flex-col gap-5 md:gap-6">
          ...
          {/* ── Hero Banner ── */}
          <div
            className="relative overflow-hidden rounded-none border border-emerald-200/60 p-6 shadow-[0px_20px_25px_-5px_rgba(16,185,129,0.14),0px_8px_10px_-6px_rgba(16,185,129,0.14)] md:p-8 dark:border-emerald-500/20"
            style={{
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="mb-4 flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-none border border-white/20 bg-white/10">
          ...
          <div className="rounded-none border border-zinc-200 bg-white px-7 py-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              {teamMembers.map(({ number, name, role }) => (
                <div
                  key={number}
                  className="flex items-center gap-3 rounded-none border border-emerald-100/70 px-3.5 py-3 dark:border-zinc-700/50"
                  style={{
                    background:
                      'linear-gradient(174deg, rgba(236,253,245,0.9) 0%, rgba(240,253,250,0.9) 100%)',
                  }}
                >
                  <div
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            {/* Institusi */}
            <div
              className="rounded-none border border-emerald-200 px-6 py-5 dark:border-zinc-700"
              style={{
                background: 'linear-gradient(160deg, rgba(236,253,245,0.95) 0%, rgba(240,253,250,0.95) 100%)',
              }}
            >
              <div className="mb-4 flex items-center gap-2">
